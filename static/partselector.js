...
var mobo_lst = { 160: { 100: "GIGABYTE B560M DS3H LGA 1200 Intel B560 Intel Motherboard" }, 179: { 135: "ASRock B560M STEEL LEGEND" }, 213: { 135: "ASRock B560M STEEL LEGEND" }, 228: { 180: "GIGABYTE B560M AORUS PRO AX LGA 1200 Intel B560 Intel Motherboard(if you want to overclock get a z590 motherboard" }, 290: { 150: "ASUS TUF GAMING B550M-PLUS (Wi-Fi) AMD AM4 " }, 398: { 195: "ASRock X570 STEEL LEGEND AM4 AMD X570" }, 570: { 195: "ASRock X570 STEEL LEGEND AM4 AMD X570" }, 819: { 410: "Asus X570 ROG Crosshair VIII Hero Wi-Fi" } }
...
base_table.setAttribute("style","border-style: hidden;margin-top: 10%;padding-bottom: 10%")
...
base_row.setAttribute("style","margin-left:;margin-right: auto;border: hidden;")
...
cpu_ta.setAttribute("style","height: 30px;Color:white;border: hidden;")
cpu_ta.innerText = "Processor"
parent_row.appendChild(cpu_ta) 

cpul_ta = document.createElement("td")
cpul_ta.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left;text-align:center")
cpul_ta.innerText = cpu_budget2
parent_row.appendChild(cpul_ta) 

cpup_ta = document.createElement("td")
cpup_ta.setAttribute("style","padding-left: 10%;height: 30px;Color:white;border: hidden;margin-right:auto;padding-left: 10%")
...
base_row2.setAttribute("style","margin-left:;margin-right: auto;border: hidden;")
...
gpul_ta2.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left:")
gpul_ta2.innerText = "Graphics card"
parent_row2.appendChild(gpul_ta2) 

gpu_ta2 = document.createElement("td")
gpu_ta2.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left;text-align: center;")
gpu_ta2.innerText = gpu_budget2
parent_row2.appendChild(gpu_ta2) 

gpup_ta2 = document.createElement("td")
gpup_ta2.setAttribute("style","padding-left: 10%;height: 30px;Color:white;border: hidden;margin-right:auto;margin-left:")
...
base_row3.setAttribute("style","margin-left:;margin-right: auto;border: hidden;")
...
storagel_ta3.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left:")
storagel_ta3.innerText = "Storage"
parent_row3.appendChild(storagel_ta3) 

storage_ta3 = document.createElement("td")
storage_ta3.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left;text-align: center")
storage_ta3.innerText = storage_budget2
parent_row3.appendChild(storage_ta3) 

storagep_ta3 = document.createElement("td")
storagep_ta3.setAttribute("style","padding-left: 10%;height: 30px;Color:white;border: hidden;margin-right:auto;margin-left: ")
...
base_row4.setAttribute("style","margin-left:;margin-right: auto;border: hidden;")
...
psul_ta4.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left:")
psul_ta4.innerText = "Power Supply"
parent_row4.appendChild(psul_ta4) 

psu_ta4 = document.createElement("td")
psu_ta4.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left;text-align:center;")
psu_ta4.innerText = psu_budget2
parent_row4.appendChild(psu_ta4) 

psup_ta4 = document.createElement("td")
psup_ta4.setAttribute("style","padding-left: 10%;height: 30px;Color:white;border: hidden;margin-right:auto;margin-left: ")
...
base_row5.setAttribute("style","margin-left:;margin-right: auto;border: hidden;")
...
mobol_ta5.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left:")
mobol_ta5.innerText = "Motherboard"
parent_row5.appendChild(mobol_ta5) 

mobo_ta5 = document.createElement("td")
mobo_ta5.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left;text-align: center")
mobo_ta5.innerText = Object.values(mobo_lst[cpu_budget])
parent_row5.appendChild(mobo_ta5) 

mobop_ta5 = document.createElement("td")
mobop_ta5.setAttribute("style","padding-left: 10%;height: 30px;Color:white;border: hidden;margin-right:auto;margin-left: ")
...
base_row6.setAttribute("style","margin-left:auto;margin-right: auto;border: hidden;")
...
raml_ta6.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left:")
raml_ta6.innerText = "Ram"
parent_row6.appendChild(raml_ta6) 

ram_ta6 = document.createElement("td")
ram_ta6.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left;text-align: center")
ram_ta6.innerText = ram_budget2
parent_row6.appendChild(ram_ta6) 

ramp_ta6 = document.createElement("td")
ramp_ta6.setAttribute("style","padding-left: 10%;height: 30px;Color:white;border: hidden;")
...
base_row7.setAttribute("style","margin-left:;margin-right: auto;border: hidden;")
...
remainl_ta7.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;")
remainl_ta7.innerText = "Remainder"
parent_row7.appendChild(remainl_ta7) 

remain_ta7 = document.createElement("td")
remain_ta7.setAttribute("style","height: 30px;Color:white;border: hidden;margin-right:auto;margin-left;text-align: center")
remain_ta7.innerText = "Total cost: " + "$" + (budget - remainder)
parent_row7.appendChild(remain_ta7) 

remainp_ta7 = document.createElement("td")
remainp_ta7.setAttribute("style","padding-left: 10%;height: 30px;Color:white;border: hidden;margin-right:auto; ")
